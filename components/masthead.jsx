...
const Masthead = () => {
    ...
    return (
        ...
        >
            ...
            <motion.div className={`mt-9 sm:mt-0 p-12 font-bold z-10 text-white flex-1 flex items-start justify-center flex-col`}
                initial={{ opacity: 0, x: -100 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 2 }}
            >
                <div className='flex items-end'>
                    <h1 className='mb-3 text-7xl sm:text-[140px] lg:text-[170px]'>Digital</h1>
                    <motion.div
                        initial={{ opacity: 0, }}
                        animate={{ opacity: 1, }}
            ...
            <motion.div class="-mt-9 -mb-9 relative flex overflow-x-hidden overflow-y-hidden"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 2 }}
            >
                <div className='text-7xl sm:text-[140px] lg:text-[170px] place-self-center text-bold text-white'>
                    <div class="animate-marquee whitespace-nowrap">
                        <span class="mx-4 font-bold">Experience</span>
                        <span class="mx-4 font-bold">Experience</span>
                        <span class="mx-4 font-bold">Experience</span>
                    </div>
            ...
            <motion.div className={`p-12 font-bold z-10 text-white flex-1 flex items-start justify-center flex-col`}
                initial={{ opacity: 0, x: 100 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 2 }}
            >
